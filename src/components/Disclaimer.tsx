...
const Disclaimer: React.FC<DisclaimerProps> = ({ onAccept }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 z-[100] flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 mx-auto my-8">
        <h2 className="text-2xl font-playfair font-bold text-gray-800 mb-4">Legal Disclaimer</h2>
        <div className="prose prose-sm mb-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
